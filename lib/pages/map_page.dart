...
/// صفحة الخريطة - تعرض مواقع العربات الذكية والنباتات المخصبة
...
class _MapPageState extends State<MapPage> {
  ...
  Set<Marker> get _displayedMarkers {
    ...
    if (_showSmartBins) {
      // تخصيص ألوان مختلفة للعربات حسب الحالة
      for (var marker in _smartBinsMarkers) {
        markers.add(marker);
      }
    }

    if (_showPlants) {
      for (var marker in _plantsMarkers) {
        markers.add(marker);
      }
    }
        ...
        children: [
          ...
          GoogleMap(
            ...
            initialCameraPosition: const CameraPosition(
              ...
              zoom: 10.0, // تكبير مناسب لإظهار المنطقة
            ),
          ...
          // قائمة المواقع القريبة في منطقة عسير
          Positioned(
            bottom: 16,
            left: 16,
            right: 16,
                ...
                children: [
                  _LocationCard(
                    ...
                    onTap: () => _showLocationDetails(
                      ...
                      'عربة ذكية في وسط مدينة أبها، عاصمة منطقة عسير. متاحة للاستخدام بمساحة فارغة 75%. مكان مثالي للتخلص من النفايات العضوية والحصول على نقاط بيئية.',
                    ),
                  ),
                  _LocationCard(
                    title: 'منتزه عسير الوطني',
                    ...
                    onTap: () => _showLocationDetails(
                      'منتزه عسير الوطني',
                      'أكبر منتزه وطني في المملكة يقع في أبها. تم تسميد أشجار العرعر البرية بالسماد الطبيعي المنتج من النفايات العضوية. شكراً لمساهمتك في حماية هذا التراث الطبيعي!',
                    ),
                  ),
                  _LocationCard(
                    title: 'عربة ذكية - خميس مشيط',
                    subtitle: 'متاحة - حي المطار',
                    icon: Icons.delete_outline,
                    color: const Color(0xFF4CAF50),
                    onTap: () => _showLocationDetails(
                      'عربة ذكية - خميس مشيط',
                      'عربة ذكية في مدينة خميس مشيط، المدينة التوأم لأبها. متاحة للاستخدام بمساحة فارغة 85%. ساهم في حماية البيئة الجبلية الجميلة.',
                    ),
                  ),
                  _LocationCard(
                    title: 'غابات السودة',
                    ...
                    onTap: () => _showLocationDetails(
                      ...
                      'أعلى قمة في المملكة (3015م فوق سطح البحر). تم تسميد أشجار العرعر البرية النادرة بالسماد الطبيعي. هذه الغابات تمثل كنزاً بيئياً فريداً يجب المحافظة عليه.',
                    ),
                  ),
                  _LocationCard(
                    title: 'عربة ذكية - النماص',
                    ...
                    onTap: () => _showLocationDetails(
                      'عربة ذكية - النماص',
                      'عربة ذكية في مدينة النماص الجبلية الباردة. متاحة بمساحة فارغة 90%. ساهم في حماية البيئة الجبلية والمناخ المعتدل في هذه المنطقة الجميلة.',
                    ),
                  ),
                  _LocationCard(
                    title: 'حدائق النماص الجبلية',
                    subtitle: 'تم التسميد - أشجار اللوز',
                    icon: Icons.local_florist,
                    color: const Color(0xFF66BB6A),
                    onTap: () => _showLocationDetails(
                      'حدائق النماص الجبلية',
                      'حدائق جبلية رائعة تشتهر بأشجار اللوز والخوخ. تم تسميدها بالسماد الطبيعي قبل 5 أيام. تزهر هذه الأشجار في الربيع بألوان خلابة بفضل التسميد الطبيعي.',
                    ),
                  ),
                ],
              ),
